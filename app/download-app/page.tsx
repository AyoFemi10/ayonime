const APK_URL = "https://github.com/AyoFemi10/ayonime-app/releases/latest/download/AYONIME.apk.zip";
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 pt-28 pb-20 flex flex-col items-center gap-10 text-center">
      ...
      <div className="w-full bg-ayo-card border border-ayo-border rounded-2xl p-6 text-left flex flex-col gap-4">
        ...
        {[
          { n: "1", text: 'Tap "Download ZIP" above — the file downloads as AYONIME.apk.zip' },
          { n: "2", text: 'Open your Downloads folder and extract the ZIP — you\'ll get AYONIME.apk inside' },
          { n: "3", text: 'Tap the AYONIME.apk file to install it' },
          { n: "4", text: 'If prompted, tap "Install anyway" or enable "Install from unknown sources" in Settings → Security' },
          { n: "5", text: "Open AYONIME and start watching" },
        ].map((s) => (
      ...
      {/* ZIP note */}
      <div className="w-full bg-ayo-surface border border-ayo-border rounded-xl px-5 py-4 flex items-start gap-3 text-left">
        <span className="text-xl shrink-0">📦</span>
        <p className="text-ayo-muted text-sm leading-relaxed">
          The app is distributed as a ZIP file. After downloading, extract it to get the <span className="text-white font-semibold">AYONIME.apk</span> installer. Most Android file managers can open ZIP files directly.
        </p>
      </div>
